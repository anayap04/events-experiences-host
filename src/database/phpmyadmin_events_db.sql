...
('1001', 'paolaanaya', 'Paola Anaya', 'paola@anayap.tech', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&auto=format', 'Microfrontend Host Lead & Software Architect', 42, 'admin', 1),
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `thumbnail` TEXT,
  `mfe_remote_url` TEXT,
  `created_by` VARCHAR(100) DEFAULT 'paolaanaya',
...
('1', 'Rivera Family Baby Shower', 'rivera-baby-shower', 'https://babyshower.riveras.family', 'A private celebration page for our baby shower — RSVP, gift registry, venue details, and photo album for guests.', 'Baby Shower', 'active', 'https://images.unsplash.com/photo-1512820790803-83ca734da794?w=600&h=340&fit=crop&auto=format', 'https://events.anayap.tech/remoteEntry.js', 'paolaanaya', '2026-07-15', '2026-09-10'),
('2', 'Q3 Product Leadership Offsite', 'product-leadership-offsite', 'https://offsite.internal.acme.co', 'Private agenda, session notes, speaker bios, and hotel info for the 3-day leadership conference in Sonoma.', 'Conference', 'active', 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=600&h=340&fit=crop&auto=format', 'https://events.anayap.tech/remoteEntry.js', 'paolaanaya', '2026-06-01', '2026-09-05'),
...
('4', 'Chen & Nakamura Wedding', 'chen-nakamura-wedding', 'https://chennakamura.wedding', 'Wedding info hub with ceremony details, accommodation options, dietary preferences form, and a live photo stream for guests.', 'Wedding', 'active', 'https://images.unsplash.com/photo-1519741497674-611481863552?w=600&h=340&fit=crop&auto=format', 'https://experiences.anayap.tech/remoteEntry.js', 'paolaanaya', '2026-03-10', '2026-08-28'),
...
('6', 'Design Dept Farewell — Mia', 'design-farewell-mia', 'https://farewell.mia.internal', 'Team farewell for Mia Santos — a private tribute page where colleagues can leave messages, share memories, and view the event schedule.', 'Farewell', 'archived', 'https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=600&h=340&fit=crop&auto=format', 'https://tickets.anayap.tech/remoteEntry.js', 'paolaanaya', '2025-11-05', '2025-12-14')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
